...
%% PRT Conditions
condNames = {'Rest','MotorImagery', ...
              'Noise','Music','Report','Inter'};

blockDuration = [ 8 8 8 8 4 4 ]; %in volumes (think TR = 1500ms)

blockColor = [216 83 25 ; 236 177 32 ; ...
...
SEQ = [ 1 2 3 4 5 6 1 2 3 4 5 6 1 2 3 4 5 6 1 2 3 4 5 6 1 2 3 4 5 6 1 2 3 4 5 6 1 2 3 4 5 6 1 2 3 4 5 6 1 ];
 
[ PRTConditions_R2 ] = buildIntervals( SEQ , PRTConditions );

generatePRT( PRTParameters , PRTConditions_R2 , 'MusicNF_Localizer_v0.3_PostDiscard' , outputFolder );
