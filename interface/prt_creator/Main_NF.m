...
%% PRT Conditions
condNames = {'Discard','Rest','MotorImagery','RestFinal'};

blockDuration = [ 8 20 20 8 ]; %in volumes (think TR = 1500ms)

blockColor = [0 115 190 ; 216 83 25 ; 236 177 32 ; 110 115 190];
...
%% Run MRI D12 R2
SEQ = [ 1 2 3 2 3 2 3 2 3 2 3 2 3 4 ];

[ PRTConditions_R2 ] = buildIntervals( SEQ , PRTConditions );

generatePRT( PRTParameters , PRTConditions_R2 , 'MusicNF_Main_v0.3' , outputFolder );
